          ...
          <div className="swiper-wrapper">
            <div className="swiper-slide !w-fit">
              <div className="w-[700px] h-[550px] overflow-hidden">
                <img src="/assets/images/thumbnails/thumbnail-details-1.png" className="w-full h-full object-cover" alt="thumbnail" />
              </div>
            </div>
            <div className="swiper-slide !w-fit">
              <div className="w-[700px] h-[550px] overflow-hidden">
                <img src="/assets/images/thumbnails/thumbnail-details-2.png" className="w-full h-full object-cover" alt="thumbnail" />
              </div>
            </div>
            <div className="swiper-slide !w-fit">
              <div className="w-[700px] h-[550px] overflow-hidden">
                <img src="/assets/images/thumbnails/thumbnail-details-3.png" className="w-full h-full object-cover" alt="thumbnail" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="Details" className="relative flex max-w-[1130px] mx-auto gap-[30px] mb-20 z-10">
        <div className="flex flex-col w-full rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
          ...
          <p className="leading-[30px]">
            Whether you need quite private space away from the distractions of an at-times chaotic home office, you’re on a team that needs to brainstorm and collaborate in person, or you’re owner meeting with prospective hires, clients,
            and partners, having access to hundreds of workspaces can be a game-changing resource.
          </p>
        ...
        <div className="w-[392px] flex flex-col shrink-0 gap-[30px]">
          <div className="flex flex-col rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
            <div>
              <p className="font-extrabold text-[32px] leading-[48px] text-[#0D903A]">Rp 18.540.000</p>
